...
class BetterMessagesSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['position']['width'] = array(
      ...
      '#description' => $this->t('Width in pixel. Example: 400px<br />Or percentage. Example: 100%'),
    ...
    $form['jquery_ui'] = array(
      ...
      '#weight' => 10,
      '#description' => $this->t('These settings require !jquery_ui'),
      '#open' => TRUE,
    );
  ...
  protected function buildVisibility($form, FormStateInterface $form_state) {
    ...
    foreach ($this->conditionManager->getDefinitionsForContexts($this->contextRepository->getAvailableContexts()) as $condition_id => $definition) {
